#line 1 "d:\\DOCUMENT\\pro\\withing2.0\\arduino\\homeKit_AC\\HTTPSimpleClient.cpp"
...
{
#ifdef DEBUG_HTTPCLIENT
  DBG_OUTPUT_PORT.println("writeToStream");
#endif
	if (!stream) {
    #ifdef DEBUG_HTTPCLIENT
  DBG_OUTPUT_PORT.println("HTTPC_ERROR_NO_STREAM");
#endif
...
#ifdef DEBUG_HTTPCLIENT
  DBG_OUTPUT_PORT.println("processing _transferEncoding:"+String(_transferEncoding));
#endif
...
#ifdef DEBUG_HTTPCLIENT
  DBG_OUTPUT_PORT.print("chunkHeader:");
   DBG_OUTPUT_PORT.println(chunkHeader);
#endif
